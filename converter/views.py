...
def index(request):
	...
	converted_amount = round(cc.convert(amount, first_currency, second_currency,), 3) #date=currency_date
	context = {'form': form, 'first_currency': first_currency, 'second_currency': second_currency, 'amount': amount, 'converted_amount': converted_amount, 'currency_date': currency_date} 
